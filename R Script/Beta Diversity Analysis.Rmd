...
pw_results1 <- lapply(combs1, function(pair) {
  ...
  sub_dist1 <- as.dist(dist_mat[rownames(sub_meta1), rownames(sub_meta1)])
...
pw_results2 <- lapply(combs2, function(pair) {
  ...
  sub_dist2 <- as.dist(dist_mat[rownames(sub_meta2), rownames(sub_meta2)])
...
taxa <- plot_bar(ps_rel, x = "Response", fill = "Genus") +
